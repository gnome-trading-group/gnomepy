"""
Vol-model-aware calibrator for BasicMMSignal.
...
class BasicMMCalibrator:
    """Calibrate BasicMMSignal parameters against a concrete VolatilityModel.
    ...
    def calibrate(
        ...
        min_volatility : float
            ...
            ``BasicMMSignal`` at runtime, otherwise the calibrated gamma
        ...
        #    applying the same min_volatility floor that BasicMMSignal uses.
    ...
    def spread_distribution(
        ...
        min_volatility : float
            Per-tick sigma floor. Must match ``BasicMMSignal.min_volatility``.
    ...
    def report(self, results: dict) -> None:
        ...
        print(f"\n{'=' * 40}")
        print(f"  BasicMM Calibration Report")
        print(f"{'=' * 40}")
    ...
    def get_recommended_parameters(
        ...
        """Run calibration and return a dict ready for ``BasicMMSignal(**params)``.
        ...
        -------
        dict
            Keys match ``BasicMMSignal.__init__`` kwargs.
        """
