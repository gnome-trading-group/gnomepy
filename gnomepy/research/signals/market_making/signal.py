"""
MarketMakingSignal — inventory-controlled infinite horizon market making
...
class MarketMakingRecord(BaseRecord):
...
class MarketMakingRecorder(BaseRecorder):

    def get_record_class(self):
        return MarketMakingRecord
...
class MarketMakingSignal(PositionAwareSignal):
    ...
    def __init__(
        ...
        recorder: "MarketMakingRecorder | None" = None,
    ):
        super().__init__()
